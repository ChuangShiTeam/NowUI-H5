...
switch(process.argv[2]) {
    ...
    case 'start':
        rewireModule('react-scripts-ie8/scripts/start.js', loadCustomizer('../config-overrides.dev'));
        break;
    // The "build" script is run to produce a production bundle
    case 'build':
        rewireModule('react-scripts-ie8/scripts/build.js', loadCustomizer('../config-overrides.prod'));
        break;
    ...
    case 'test':
        ...
        proxyquire('react-scripts-ie8/scripts/test.js', {
            ...
            '../utils/createJestConfig': (...args) => {
                ...
                var createJestConfig = require('react-scripts-ie8/utils/createJestConfig');
